    ...
    <div className="min-h-dvh flex items-center justify-center px-4">
      <div className="w-full max-w-[380px]">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="font-heading text-2xl font-black tracking-tight text-white">Full Cash</h1>
          <p className="text-text-muted text-sm mt-1">Ingresá a tu panel de finanzas</p>
        </div>

        <div className="card p-6">
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <label className="text-[12px] font-semibold text-text-secondary uppercase tracking-[0.8px]">Email</label>
              <input
                type="email"
                value={email}
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[12px] font-semibold text-text-secondary uppercase tracking-[0.8px]">Contraseña</label>
              <input
                type="password"
                value={password}
