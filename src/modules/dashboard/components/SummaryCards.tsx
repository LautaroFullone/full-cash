    ...
    <div className="animate-slide-up grid grid-cols-2 gap-3 [animation-delay:0.1s] [animation-fill-mode:backwards]">
      <div className="card p-5 relative overflow-hidden">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-xs font-semibold text-text-muted uppercase tracking-[0.5px]">Ingresos</span>
        </div>
        <p className="font-heading text-[22px] font-bold text-accent tracking-[-0.5px]">{formatCurrency(totalIngresos)}</p>
      </div>
      ...
      <div className="card p-5 relative overflow-hidden">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-xs font-semibold text-text-muted uppercase tracking-[0.5px]">Egresos</span>
        </div>
        <p className="font-heading text-[22px] font-bold text-danger tracking-[-0.5px]">-{formatCurrency(totalEgresos)}</p>
      </div>
    </div>
  )
}
