  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Tabs */}
        <div className="flex gap-0.5 bg-background rounded-full p-[3px] mb-4">
        ...
        <div className="flex flex-col gap-1.5">
          {filtered.map(cat =>
            editingId === cat.id ? (
              ...
              >
                <div className="w-[38px] h-[38px] rounded-sm bg-white/5 flex items-center justify-center shrink-0">
