...
export function CurrencyInput({
   ...
   return (
      <div className="relative">
         <span
            className={`absolute left-3.5 top-1/2 -translate-y-1/2 font-heading font-bold text-[15px] pointer-events-none select-none transition-colors duration-200 ${isFocused ? 'text-accent' : 'text-text-muted'}`}
         >
            $
         </span>
         <input
